#### Welcome to the [Shiny app](https://shiny.rstudio.com/) for fluviz, a visualization tool for influenza sequence data. fluviz is built using R, and the source code as well as example data can be found on [GitHub](https://github.com/mopratt/fluviz). You can navigate this Shiny app by selecting tools from the navigation tabs at the top of the page. These tools are intended to be used alongside the [Influenza Classification Suite](https://github.com/Public-Health-Bioinformatics/flu_classification_suite), which characterizes flu sequences *(see below)*.  
...
* [Usage](#usage)  
* [Packages](#packages)  
* [Tutorial for RStudio](#tutorial)  
* [References](#references)
  
### **Example Visualizations:**  
Metadata heatmap:  
![Image of metamap](www/metamap_image.png)  
Antigenic AA SNP plot:  
![Image of snpplot](www/snpplot_image.png)
...
![Image of Classification Suite Workflow](www/class-suite-wrkflw.jpg)  
...
![Image of Tutorial File](www/tutorial.PNG)
...
### Tutorial  
##### To visualize the output of the Classification Suite you can use this Shiny app on its own. However, if you would like to see "behind the scenes" and customize your visualizations further in RStudio, only 3 R functions are needed *(you will also need to install and load the packages listed above)*:    
1. **combine_metadata()**  
2. **metamap()** *and*  
3. **snpplot()**  
  
  The source code for these R functions is available in the **rcode** folder on GitHub. If you want to follow this tutorial in RStudio, download the R scripts for each function, open and run them in RStudio, then download the example data and follow along:  
  
![Image of R functions](www/r-code.PNG)  
*R scripts containing the functions are available in the rcode folder*  
![Image of example data](www/example-data.PNG)  
...
```
![Image of messy metamap](www/metmap-messy.png)  
...
![Image of clean metamap](www/metamap-clean.png)  
...
**Shiny:** Winston Chang, Joe Cheng, JJ Allaire, Yihui Xie and Jonathan McPherson
